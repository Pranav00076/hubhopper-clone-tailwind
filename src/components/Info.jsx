        ...
        <div className="relative bg-white pt-12 sm:pt-24">
          ...
          "
              >
                <li
                  className="
                tab-item text-center transition-opacity flex-shrink-0
                opacity-100 scale-105
              "
                >
                  <button
                    className="
                  tab-trigger focus:text-decoration-none block w-full whitespace-nowrap
              ...
              <div className="tab-container relative h-[350px] sm:h-[800px] lg:h-[900px] overflow-hidden px-4 py-8">
                <div className="absolute inset-0 transform transition-all duration-500 ease-in-out translate-x-0 opacity-100">
